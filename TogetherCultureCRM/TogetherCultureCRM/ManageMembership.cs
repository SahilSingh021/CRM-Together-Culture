...
{
    public partial class ManageMembership : Form
    {
        ...
        private void cancel_membership_btn_Click(object sender, EventArgs e)
        {
            CancelMembership newForm = new CancelMembership();
            newForm.ShowDialog();
        }
    }
}
